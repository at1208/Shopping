...
console.log(this.props)
  ...
  return <div className='b1 text-center container card shadow'>
          ...
          <div className='b4 btn-sm'>Total Items <span className='badge badge-light '>{this.props.checkout.length }</span></div>
                <button className='b8 btn-primary btn-xm'>Pay<span className='badge badge-light '>₹{Total() }</span></button>
        </div>
            <br />
